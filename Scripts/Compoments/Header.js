      ...
      <header class="header">
        ...
        <div class="overlay">
          ...
          <div
            ...
            />
            <div class="suggestions" style="display: none; position: absolute; background: #fff; z-index: 10; width: 100%; border: 1px solid #ccc; max-height: 200px; overflow-y: auto;"></div>
